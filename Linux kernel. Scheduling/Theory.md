...
- Время в ядре дискретно:
	- На материнке находится осциллятор, который раз в некоторое время гинерирует сигнал(тик), этот тик обрабатывается как прерывание, соответствующий обработчик в коде ядра инкрементит счетчик времени 
