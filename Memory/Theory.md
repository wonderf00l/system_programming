...
2. N-ассоциативный кеш
	1. подход тот же, однако тут блок основной памяти может мапиться в n блоков памяти cpu cache
	2. тогда при обращении к какому-то адресу:
		1. 
