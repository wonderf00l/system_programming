...
- Поэтому с точки зрения кода нужно по возможности сокращать такие сценарии, то есть сводить к только совместному чтению или раздельным чтению-записи(когда в кеш-линии разных ядер загружаются разные участки озу для модификации)
