...
- ***dup*** syscall - создает новый файловый дескриптор в userspace
	...
	- проще говоря, в блоке памяти с последовательно расположенными адресами структур file появляется новое вхождение, новый адрес - в этом вхождении будет лежать адрес на уже существующую ***struct file*** 
